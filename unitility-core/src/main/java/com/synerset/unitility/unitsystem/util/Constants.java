...
public class Constants {
    ...
    public static final double PINTS_PER_GALLON = 8;
    public static final double OUNCE_PER_GALLON_UK = 160;
    public static final double OUNCE_PER_GALLON_US = 128;
    // Derived Volume
    ...
    public static final double PINTS_PER_CUBIC_METER = GALLONS_US_PER_CUBIC_METER * PINTS_PER_GALLON;
    public static final double OUNCE_PER_CUBIC_METER = GALLONS_US_PER_CUBIC_METER * OUNCE_PER_GALLON_US;
    ...
    public static final double KILOGRAMS_PER_OUNCE = 1/OUNCES_PER_KILOGRAM;
    ...
    public static final double JOULES_PER_BTU = 1055.05585262;
    public static final double JOULES_PER_CALORIE = 4.184;
    public static final double BTU_PER_POUND = 2326;

    // Derived Force
    public static final double POUND_FORCE_PER_NEWTON = KILOGRAMS_PER_POUND * GRAVITY_SI;
    // This derived value from SI units differs from the standard definition
    // public static final double POUNDAL_PER_NEWTON_DERIVED = KILOGRAMS_PER_POUND * GRAVITY_SI / GRAVITY_FEET_PER_SECOND_SQUARED;
    ...
    // This is technically derivable, but with floating point error, a static definition is more accurate
    // public static final double PASCAL_PER_PSI_DERIVED = 1/(POUNDS_PER_KILOGRAM * FEET_PER_METER/ GRAVITY_FEET_PER_SECOND_SQUARED  / SQUARE_INCHES_PER_SQUARE_METER);
    ...
    // Canonical Power
    // This is technically derivable, but with floating point error, a static definition is more accurate
    public static final double WATTS_PER_IMPERIAL_HORSEPOWER = 745.69987158227022;
    // public static final double WATTS_PER_IMPERIAL_HORSEPOWER_DERIVED = HORSEPOWER / SECONDS_PER_MINUTE / FEET_PER_METER / POUNDS_PER_KILOGRAM * GRAVITY_SI;
    public static final double IMPERIAL_SPECIFIC_HEAT_RATIO = 4186.7999934703;
    public static final double IMPERIAL_THERMAL_CONDUCTIVITY_RATIO = 1.7307352822121;
